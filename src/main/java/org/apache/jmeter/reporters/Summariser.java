...
public class Summariser extends AbstractTestElement
    ...
    public static AutomationPerformanceTestingSummarizedResults results;
    /*
    ...
    private static String format(String name, SummariserRunningSample summariserRunningSample, String type) {
        ...
        sb.append(type);
        sb.append(' ');
        StringBuilder noOfSamples=longToSb(tmp, summariserRunningSample.getNumSamples(), 6);
        sb.append(noOfSamples);
        sb.append(" in ");
        long elapsed = summariserRunningSample.getElapsed();
        long elapsedSec = (elapsed + 500) / 1000; // rounded seconds
        String elapsedTime=JOrphanUtils.formatDuration(elapsedSec);
        sb.append(JOrphanUtils.formatDuration(elapsedSec));
        sb.append(" = ");
        String hitRate;
        if (elapsed > 0) {
            hitRate=doubleToSb(dfDouble, tmp, summariserRunningSample.getRate(), 6, 1).toString();
        ...
        sb.append("/s Avg: ");
        String average=longToSb(tmp, summariserRunningSample.getAverage(), 5).toString();
        sb.append(longToSb(tmp, summariserRunningSample.getAverage(), 5));
        sb.append(" Min: ");
        String min=longToSb(tmp, summariserRunningSample.getMin(), 5).toString();
        sb.append(longToSb(tmp, summariserRunningSample.getMin(), 5));
        sb.append(" Max: ");
        String max=longToSb(tmp, summariserRunningSample.getMax(), 5).toString();
        sb.append(longToSb(tmp, summariserRunningSample.getMax(), 5));
        sb.append(" Err: ");
        String errorCount=longToSb(tmp, summariserRunningSample.getErrorCount(), 5).toString();
        sb.append(longToSb(tmp, summariserRunningSample.getErrorCount(), 5));
        sb.append(" (");
        String errorPercentage=summariserRunningSample.getErrorPercentageString();
        ...
        results= new AutomationPerformanceTestingSummarizedResults(elapsedTime, hitRate, average, min, max, errorCount, errorPercentage);
        return sb.toString();
    }
